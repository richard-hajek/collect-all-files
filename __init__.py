...
def getthemall(context):
                    ...
                    if obj.type == 'MOVIE':
                        ...
                        if os.path.exists(newpath) == True:
                            ...
                            if obj.filepath == newpath:
                                file.write(
                                    "    VIDEO STRIP IGNORED : " + obj.name + " already copied and linked to " + bpy.path.basename(
                                        obj.filepath) + "\n")
                                print(bpy.path.basename(obj.filepath) + " already copied/linked - VIDEO STRIP IGNORED")

                            else:
                                obj.filepath = newpath
                                file.write("    VIDEO STRIP LINKED : " + obj.name + " linked to " + bpy.path.basename(
                                    obj.filepath) + "\n")
                            ...
                            obj.filepath = newpath
                            file.write("    VIDEO STRIP COPIED : " + obj.name + " linked to " + bpy.path.basename(
                                obj.filepath) + "\n")
                    ...
                    ### Problème avec image fixe à régler ###    
                        ...
                        if obj.frame_duration == 1:
                            ...
                            if obj.directory == sfolder:
                                ...
                                file.write(
                                    "    IMAGE STRIP IGNORED : " + obj.name + " already copied and linked to " + bpy.path.basename(
                                        obj.filepath) + "\n")
                                ...
                                if os.path.exists(Inewpath) == True:
                                    ...
                                    file.write(
                                        "    IMAGE STRIP LINKED : " + obj.name + " linked to " + bpy.path.basename(
                                            obj.filepath) + "\n")
                                    ...
                                    obj.directory = sfolder
                                    file.write(
                                        "    IMAGE STRIP COPIED : " + obj.name + " linked to " + bpy.path.basename(
                                            obj.filepath) + "\n")
                            ...
                            if obj.directory == ISnewpath:
                                ...
                                file.write(
                                    "    IMAGE SEQUENCE STRIP IGNORED : " + obj.name + " already copied and linked to " + bpy.path.basename(
                                        obj.filepath) + "\n")
                                print(obj.elements[
                                          0].filename + " sequence already copied/linked - IMAGE SEQUENCE STRIP IGNORED")
                                ...
                                if os.path.exists(ISnewpath) == True:
                                    ...
                                    file.write(
                                        "    IMAGE SEQUENCE STRIP LINKED : " + obj.name + " linked to " + bpy.path.basename(
                                            obj.filepath) + "\n")
                                    ...
                                    obj.directory = ISnewpath
                                    file.write(
                                        "    IMAGE SEQUENCE STRIP COPIED : " + obj.name + " linked to " + bpy.path.basename(
                                            obj.filepath) + "\n")
                        ...
                        if os.path.isfile(vnewpath) == True:
                            ...
                            if obj.sound.filepath == vnewpath:
                                file.write(
                                    "    SOUND STRIP IGNORED : " + obj.name + " already copied and linked to " + bpy.path.basename(
                                        obj.sound.filepath) + "\n")
                                print(bpy.path.basename(obj.sound.filepath) + " already copied/linked - SOUND IGNORED")

                            else:
                                obj.sound.filepath = vnewpath
                                file.write("    SOUND STRIP LINKED : " + obj.name + " linked to " + bpy.path.basename(
                                    obj.sound.filepath) + "\n")
                            ...
                            if os.path.isfile(newpath) == True:
                                ...
                                if obj.sound.filepath == newpath:
                                    file.write(
                                        "    SOUND STRIP IGNORED : " + obj.name + " already copied and linked to " + bpy.path.basename(
                                            obj.sound.filepath) + "\n")
                                    print(bpy.path.basename(
                                        obj.sound.filepath) + " already copied/linked - SOUND IGNORED")

                                else:

                                    obj.sound.filepath = newpath
                                    file.write(
                                        "    SOUND STRIP LINKED : " + obj.name + " linked to " + bpy.path.basename(
                                            obj.sound.filepath) + "\n")
                                    print(bpy.path.basename(obj.sound.filepath) + " - SOUND LINKED")
                                ...
                                obj.sound.filepath = newpath
                                file.write("    SOUND STRIP COPIED : " + obj.name + " linked to " + bpy.path.basename(
                                    obj.sound.filepath) + "\n")
        ...
        if obj is not None:
            ...
            if obj.filepath == '':
                ...
                if obj.filepath == newpath:
                    ...
                    file.write("    IMAGE IGNORED : " + obj.name + " already copied and linked to " + bpy.path.basename(
                        obj.filepath) + "\n")
                    ...
                    obj.filepath = newpath
                    file.write(
                        "    IMAGE LINKED : " + obj.name + " linked to " + bpy.path.basename(obj.filepath) + "\n")
                    ...
                    obj.filepath = newpath
                    file.write(
                        "    IMAGE COPIED : " + obj.name + " linked to " + bpy.path.basename(obj.filepath) + "\n")
    ...
    for obj in clip:
        ...
        if obj is not None:
            ...
            if obj.filepath == newpath:
                ...
                file.write(
                    "    MOVIE CLIP IGNORED : " + obj.name + " already copied and linked to " + bpy.path.basename(
                        obj.filepath) + "\n")
                ...
                file.write(
                    "    IMAGE SEQUENCE IGNORED : " + obj.name + " already copied and linked to " + bpy.path.basename(
                        obj.filepath) + "\n")
                ...
                if obj.source == 'SEQUENCE':
                    if os.path.exists(Snewpath) == True:
                        obj.filepath = Sfpath
                        file.write("    IMAGE SEQUENCE LINKED : " + obj.name + " linked to " + bpy.path.basename(
                            obj.filepath) + "\n")
                        ...
                        obj.filepath = Sfpath
                        file.write("    IMAGE SEQUENCE COPIED : " + obj.name + " linked to " + bpy.path.basename(
                            obj.filepath) + "\n")
                    ...
                    obj.filepath = newpath
                    file.write(
                        "    MOVIE CLIP COPIED : " + obj.name + " linked to " + bpy.path.basename(obj.filepath) + "\n")
    ...
    for obj in lib:
        ...
        if obj is not None:
            ...
            if obj.filepath == newpath:
                file.write(
                    "    BLEND LIBRARY IGNORED : " + obj.name + " already copied and linked to " + bpy.path.basename(
                        obj.filepath) + "\n")
                ...
                obj.filepath = newpath
                file.write(
                    "    BLEND LIBRARY LINKED : " + obj.name + " linked to " + bpy.path.basename(obj.filepath) + "\n")
                ...
                obj.filepath = newpath
                file.write(
                    "    BLEND LIBRARY COPIED : " + obj.name + " linked to " + bpy.path.basename(obj.filepath) + "\n")
        ...
        if obj is not None:
            ...
            if obj.filepath == '':
                ...
                if obj.filepath == newpath:
                    ...
                    file.write("    FONT IGNORED : " + obj.name + " already copied and linked to " + bpy.path.basename(
                        obj.filepath) + "\n")
...
class CollectExternalFiles(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("get.current_scene_strips", text="Sequencer Strips from Current Scene Only",
                        icon='SEQ_SEQUENCER')
